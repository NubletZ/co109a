...
## 1. ALU-nostat
### 1.1. Picture
<img src="ALU-nostat.jpg" alt="ALU-nostat" title="ALU-nostat" height="500" />
...
## 2. ALU
### 2.1. Picture
<img src="ALU.jpg" alt="ALU" title="ALU" height="500" />
...
CHIP ALU {
   ...
   // Put you code here:
    ...
    Not16(in=opr, out=nOpr);
    Mux16(a=opr, b=nOpr, sel=no, out=out, out[0..7]=out07, out[8..15]=out815, out[15]=ng); //if out[15]==1 means the output is negative (ng==1)
    
    //use or gate to detect if the outputs is all zero
